        ...
        */}
        <PageHero
          heading={
            <>
              Things I&apos;ve{" "}
              <HighlightText variant="primary">built</HighlightText>
            </>
          }
          headingClassName="font-heading text-4xl leading-tight font-black sm:text-5xl"
          subtext="It works on my machine — and, as it turns out, everywhere else too. Products shipped in full-time and contract roles, freelance builds, and the side projects I keep coming back to. Filter by how it was built or what it was built with."
